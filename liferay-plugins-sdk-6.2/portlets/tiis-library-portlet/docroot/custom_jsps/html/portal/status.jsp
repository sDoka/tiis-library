...
<c:choose>
	...
	<c:when test="<%= noSuchResourceException %>">
		...
		<%-- Loading beautiful content instead of ugly form and setting page title to 404 --%>
		<div>
			...
			<%
				...
				try{ 
					JournalArticle journalArticle = JournalArticleLocalServiceUtil.getArticleByUrlTitle(themeDisplay.getLayout().getGroupId(), "page404");
					String articleId = journalArticle.getArticleId();				
					JournalArticleDisplay articleDisplay = JournalContentUtil.getDisplay(themeDisplay.getLayout().getGroupId(), articleId, 
