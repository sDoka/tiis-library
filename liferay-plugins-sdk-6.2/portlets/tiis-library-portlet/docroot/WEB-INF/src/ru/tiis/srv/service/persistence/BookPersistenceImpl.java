...
import ru.tiis.srv.NoSuchBookException;
import ru.tiis.srv.model.Book;
import ru.tiis.srv.model.impl.BookImpl;
import ru.tiis.srv.model.impl.BookModelImpl;
...
public class BookPersistenceImpl extends BasePersistenceImpl<Book>
	...
	@Override
	public Book updateImpl(ru.tiis.srv.model.Book book)
	...
	protected Book toUnwrappedModel(Book book) {
		...
		bookImpl.setGDriveId(book.getGDriveId());
		bookImpl.setTitle(book.getTitle());
		bookImpl.setDescription(book.getDescription());
		bookImpl.setGoogleDriveLink(book.getGoogleDriveLink());
		bookImpl.setBookLogo(book.getBookLogo());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.ru.tiis.srv.model.Book")));
