 ...
 * @author Michael
 */
public class TestAttemptImpl extends TestAttemptBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a test attempt model instance should use the {@link ru.tiis.srv.model.TestAttempt} interface instead.
	 */
	public TestAttemptImpl() {
	}
}