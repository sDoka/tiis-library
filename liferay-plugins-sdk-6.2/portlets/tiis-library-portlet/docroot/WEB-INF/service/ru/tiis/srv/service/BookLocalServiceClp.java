...
public class BookLocalServiceClp implements BookLocalService {
	public BookLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes0 = new String[] { "ru.tiis.srv.model.Book" };
		...
		_methodParameterTypes3 = new String[] { "ru.tiis.srv.model.Book" };
	...
	public java.util.List<ru.tiis.srv.model.Book> getBooks(int start, int end)
		...
		return (java.util.List<ru.tiis.srv.model.Book>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public ru.tiis.srv.model.BookBookLogoBlobModel getBookLogoBlobModel(
		...
		return (ru.tiis.srv.model.BookBookLogoBlobModel)ClpSerializer.translateOutput(returnObj);
	}
