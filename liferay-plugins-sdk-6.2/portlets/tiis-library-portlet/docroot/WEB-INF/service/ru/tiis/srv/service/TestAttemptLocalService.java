...
/**
 * Provides the local service interface for TestAttempt. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Michael
 * @see TestAttemptLocalServiceUtil
...
public interface TestAttemptLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestAttemptLocalServiceUtil} to access the test attempt local service. Add custom service methods to {@link ru.tiis.srv.service.impl.TestAttemptLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
